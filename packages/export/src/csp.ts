 ...
 * asset whose URI is not `data:`. So the release states `script-src 'none'`,
 * `style-src 'self'` and `img-src 'self' data:` truthfully, and allows no
 * origin it could never load from.
 */
...
export function planCsp(): CspPlan {
