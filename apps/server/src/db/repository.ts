...
export class ProjectRepository {
   ...
   * acceptance that landed halfway — the approval row without its events —
   * would leave a run a restarted server reads as finished with no release
   * behind it. Re-running the same approval is the retry of that publish, not a
   * conflict.
   */
