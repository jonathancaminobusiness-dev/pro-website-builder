...
import { createConversationClient } from './briefing/client.js';
import { useBriefingConversation } from './briefing/useBriefingConversation.js';
...
export default function App() {
  ...
  const conversationClient = useMemo(() => createConversationClient(API_ORIGIN), []);
  const conversation = useBriefingConversation(conversationClient, identity?.runId ?? null);
